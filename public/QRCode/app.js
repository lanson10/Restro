                ...
                if (doc.exists()) {
                    ...
                    for (let i = 1; i <= numberOfTables; i++) {
                        ...
                        qrCode.innerHTML = `
                            ...
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://lanson10.github.io/Restro/public/customer/?RestId=${userId}@table=0${i}" alt="QR Code">
                            <p>Table ${i}</p>
                        `;
...
document.getElementById("GoToDashboard").addEventListener("click", () => {
    window.location.href = `${window.location.origin}/Restro/public/dashboard/`;
});
